...
import { User, Mail, Camera, GraduationCap } from "lucide-react";
...
function Profile({ data, isLoading, refetch }) {
  const [
    updateUserProfile,
    { data: profileData, isSuccess: profileIsSucess, error: profileError },
        ...
        <div className="space-x-2">
          {!isEditing && (
            <button
              ...
              className={`text-xl font-semibold bg-gradient-to-r from-blue-600 to-purple-700  text-white px-5 py-1 rounded-md transition-all duration-300`}
            >
              Edit
            </button>
          )}
          {isEditing && (
            <>
              <button
                onClick={handlSave}
                className="text-xl font-semibold bg-green-600 hover:bg-green-700 text-white px-5 py-1 rounded-md transition-all duration-300"
              >
                Save
              </button>
              <button
                onClick={handleCancel}
                className="text-xl font-semibold bg-red-600 hover:bg-red-700 text-white px-5 py-1 rounded-md transition-all duration-300"
              >
                Cancel
              </button>
            </>
                ...
                {isEditing && (
                  <>
                    ...
                    <button
                      ...
                      className="absolute right-0 top-16 bg-blue-700 rounded-full  p-2"
                    >
            ...
            <div className=" space-y-4 mt-10 relative">
              <div className="flex items-center ">
                ...
                <input
                  ...
                  className="dark:text-white  focus:outline-none dark:bg-gray-900 w-full md:w-64 "
                  type="text"
                  name="username"
              ...
              <div className="flex items-center text-White">
                ...
                <input
                  onChange={handleChange}
                  className="dark:text-white focus:outline-none dark:bg-gray-900 w-full md:w-96"
                  type="text"
                  name="email"
                  value={profile?.email || ""}
                  readOnly={!isEditing}
              ...
              <div className="flex items-center text-White">
                ...
                <select
                  ...
                  disabled={!isEditing}
                  value={profile.role}
                  className="dark:text-white  dark:bg-gray-900 sm:w-fit sm:pr-3   w-full  appearance-none"
                  name="role"
                  id=""
                >
