...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      description:
        "Soon, you’ll be able to convert lectures to text and get smart, personalized help with your studies.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "A dedicated dashboard to help instructors monitor student progress, course engagement, and earnings in real-time.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Access your courses anywhere with our mobile-optimized platform",
      benefits: [
        "iOS & Android apps",
        "Offline viewing",
        "Sync across devices",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Our comprehensive learning platform is designed to help you achieve
            your goals with the best tools and support
          </p>
        </div>
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="border p-6 rounded-lg shadow hover:shadow-lg transition-shadow duration-300 dark:border-gray-700 bg-white dark:bg-gray-800"
              >
