  ...
  return (
    ...
    <div className='max-w-7xl mx-auto px-10 my-2 '>
      ...
      <div className='my-6 space-y-2'>
        ...
        <input onChange={(e)=>setCourseTitle(e.target.value)} className='shadow-md outline-none py-2 px-4 w-full lg:w-4/5 dark:placeholder:text-gray-200 text-black dark:text-white rounded-md dark:bg-gray-900 border' name='courseTitle' value={courseTitle} type="text" placeholder="Course Name" />
      </div>
      {/* Category */}
      ...
      <div className='flex flex-wrap my-4 gap-2'>
        <button onClick={() => navigate("/admin/course")} className='bg-white dark:text-black rounded-md font-semibold px-3 py-1 shadow-md transition-transform transform hover:scale-105 duration-300 will-change-transform'>Back</button>
