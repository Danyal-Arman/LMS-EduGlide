...
import { BookOpen, Sun, AlignJustify } from "lucide-react";
        ...
        <section className="flex gap-3 ">
          ...
          {!data?.user ? (
            ...
            <>
              ...
              >
                ...
                {navbarIsOpen && (
                  <div className="absolute -right-4 bg-white z-10 dark:bg-gray-900 border transform transition-all duration-300 origin-top w-56 rounded-md shadow-md hover:cursor-pointer mt-1">
                    ...
                    <div>
                      <Link
                        className="block  hover:bg-gray-200 dark:hover:bg-gray-800 px-4 py-2 hover:px-6    transition-all duration-500 "
                        to="/"
                      >
                        Home
                      </Link>
                      ...
                      <button
                        ...
                        className="flex justify-start dark:hover:bg-gray-800 hover:bg-gray-200 text-red-600 dark:text-red-400 w-full  px-4 py-2 hover:px-6   transition-all duration-500  "
                      >
                        Log out
                      </button>
                    </div>
              ...
              >
                <AlignJustify className="w-fit h-13  pr-3 text-purple-600  sm:hidden  " />
              </button>
            </>
          )}
        </section>
